...
export namespace Options {
    export interface XML2JSON extends XML2JS {
        spaces?: number | string
    }

    export interface XML2JS extends ChangingKeyNames, IgnoreOptions {
        compact?: boolean
        trim?: boolean
        sanitize?: boolean
        nativeType?: boolean
    ...
    export interface JS2XML extends ChangingKeyNames, IgnoreOptions {
        spaces?: number | string
        compact?: boolean
        indentText?: boolean
        indentCdata?: boolean
    ...
    export interface ChangingKeyNames {
...
/**
 * Internal representation of a fully-resolved options object where every key
 * has been normalised by the option helpers. Access is intentionally dynamic
 * (e.g. `options[type + 'Key']`) so a permissive index signature is used.
 */
export type InternalOptions = Record<string, any>;
