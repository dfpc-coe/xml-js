...
export function getCommandLineHelp(command: string, requiredArgs: Array<ArgSpec>, optionalArgs: Array<ArgSpec>): string {
    const reqArgs = requiredArgs.reduce(function (res, arg) { return res + ' <' + arg.arg + '>'; }, '');
    let output = 'Usage: ' + command + reqArgs + ' [options]\n';
...
export function mapCommandLineArgs(requiredArgs: Array<ArgSpec>, optionalArgs: Array<ArgSpec>): Record<string, any> {
